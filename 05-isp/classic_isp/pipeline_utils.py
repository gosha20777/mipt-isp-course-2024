...
from classic_isp.exif_utils import parse_exif, get_tag_values_from_ifds
from classic_isp.fs import perform_storm, perform_flash
...
def denoise_image(demosaiced_image):
    current_image = denoise_bilateral(
        demosaiced_image, sigma_color=None, sigma_spatial=1., mode='reflect', channel_axis=-1)
