...
from .conv_sep_kan_block import ConvSepKANBlock


class ConvSepKANLayer(torch.nn.Module):

    def __init__(self, in_channels, out_channels, kernel_size, grid_size, spline_order,
        ...
        self.encoder = ConvSepKANBlock(in_channels, self.kan_params_num)
